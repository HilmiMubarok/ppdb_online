...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-user-graduate mr-2"></i> Daftar Siswa Diterima</a></h3><hr>
            ...
            <table class="table table-striped table-bordered">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="tombol-detail/siswa_terima.php?id=<?= $result['nisn']; ?>" class="btn btn-primary">Detail</a></td>
                        <td><a href="tombol-hapus/siswa_terima.php?id=<?= $result['nisn']; ?>">
    ...
    <script src="../js/search_terima.js"></script>
