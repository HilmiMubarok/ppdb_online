...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-images mr-2 mb-3"></i> Foto Terbaru</a></h3>
            
            <a href="tombol-tambah/tambah_foto.php" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i>Tambah Foto</a>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    <td><?= $no++;  ?></td>
                    <td><img src="../img/foto-terbaru/<?= $result['foto'] ?>" width="250"></td>
                        <td><a href="tombol-edit/edit_foto.php?id=<?= $result['id_foto']; ?>">
                            <i class="fas fa-edit bg-success text-white rounded p-2" data-toogle="tooltip" title="Edit"></i>
                        </a></td>
                        <td><a href="tombol-hapus/hapus_foto.php?id=<?= $result['id_foto']; ?>">
