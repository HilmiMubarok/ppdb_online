...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-user-graduate mr-2"></i> Daftar Siswa Ditolak</a></h3><hr>
            ...
            <table class="table table-striped table-bordered">
                ...
                <?php 
                    ...
                    $no = 1;
                    $query = mysqli_query($koneksi,"SELECT * FROM data_pendaftar WHERE status = 3 ORDER BY nama ASC");
    ...
    <script src="../js/search_tolak.js"></script>
