...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-calendar-plus mr-2 mb-3"></i> Manajemen Syarat Daftar</a></h3>
            
            <a href="tombol-tambah/tambah_syarat.php" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i>Tambah Syarat Daftar</a>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $no++;  ?></td>
                        <td><?= $result['syarat_daftar']; ?></td>
                        <td><a href="tombol-edit/edit_syarat.php?id=<?= $result['id_syarat']; ?>">
                            <i class="fas fa-edit bg-success text-white rounded p-2" data-toogle="tooltip" title="Edit"></i>
                        </a></td>
                        <td><a href="tombol-hapus/hapus_syarat.php?id=<?= $result['id_syarat']; ?>">
