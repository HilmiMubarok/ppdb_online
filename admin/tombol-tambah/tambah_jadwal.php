...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-calendar-plus mr-2 mb-3"></i> Tambah jadwal</a></h3> <hr class="mb-4">
            <form method="post">
    ...
    <?php
        ...
        $query = "INSERT INTO jadwal (kegiatan, tanggal, waktu, lokasi) VALUES ('$kegiatan', '$tanggal', '$waktu', '$lokasi')";
        $result = mysqli_query($koneksi, $query);

        if (!$result) {
                    echo "<script>
                        alert('gagal menambahkan jadwal');
                        window.location.assign('tambah_jadwal.php');
                    </script>";
                } else {
                    echo "<script>
