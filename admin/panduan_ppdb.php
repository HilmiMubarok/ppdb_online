...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-question-circle mr-2 mb-3"></i> Panduan PPDB Online</a></h3>
            
            <a href="tombol-tambah/tambah_panduan.php" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i>Tambah Panduan</a>

            <table class="table table-striped table-bordered">
                <thead class="text-center">
                    <tr>
                        <th scope="col">No</th>
                        <th scope="col">Panduan PPDB</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $no++;  ?></td>
                        <td><?= $result['panduan_ppdb']; ?></td>
                       <td><a href="tombol-edit/edit_panduan.php?id=<?= $result['id_panduan']; ?>">
                            <i class="fas fa-edit bg-success text-white rounded p-2" data-toogle="tooltip" title="Edit"></i>
                        </a></td>
                        <td><a href="tombol-hapus/hapus_panduan.php?id=<?= $result['id_panduan']; ?>">
