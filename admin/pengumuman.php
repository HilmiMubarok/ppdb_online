...
<body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-clipboard-list mr-2 mb-3"></i> pengaturan buka / tutup pengumuman</a></h3><hr class="mb-4">

            <div class="card">
                <div class="card-header">
                    Pengaturan Aktif / Non Aktif pengumuman
                </div>
                <div class="card-body">
    ...
    <?php 
        ...
        $query = "UPDATE manage_pengumuman SET status = '$name' ";
